...
import { Mail, MapPin, Send, MessageSquare, Phone, CheckCircle, AlertCircle } from 'lucide-react'
...
const contactInfo = [
  {
    icon: Mail,
    label: "Email",
    value: "vadneysilva@hotmail.com",
    href: "mailto:vadneysilva@hotmail.com",
  },
  {
    icon: Phone,
    label: "Phone",
    value: "+27 69 599 4778",
    href: "tel:+27695994778",
  },
  {
    icon: MapPin,
    label: "Location",
    value: "Hermanus, Western Cape, South Africa",
    href: "https://maps.app.goo.gl/Mhg89SmNZenb2JZf7",
  },
];
    ...
    <section id='contact' className='relative py-20 bg-background overflow-hidden'>
      ...
      <div className='w-full px-4 py-8 flex flex-col items-center justify-center'>
         <div className="flex flex-col justify-center lg:grid lg:grid-cols-2 items-center gap-12 max-w-5xl mx-auto">
          <div className="glass p-8 rounded-md border border-primary/30 animate-fade-in animation-delay-300">
            <form className="space-y-6" onSubmit={handleSubmit}>
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-surface rounded-md border border-border focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 bg-surface rounded-md border border-border focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all resize-none"
                />
              </div>
          ...
          <div className="space-y-6 animate-fade-in animation-delay-400">
            ...
            {/* Availability Card */}
            <div className="glass rounded-md p-8 border border-primary/30 my-4">
